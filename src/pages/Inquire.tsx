        ...
        <VStack spacing={5} maxW={defaultContainerSize} margin={"auto"} py={5}>
          ...
          <SimpleGrid columns={[1, 2]} width={"100%"}>
            <VStack alignItems={"start"}>
              ...
              <Text>
                <Icon as={BsGeoAlt} color={projectColorTertiary} /> Dr Arcadio
                Santos Ave, San Antonio, Parañaque, 1700 Metro Manila
              </Text>
              <Heading size="md" color={projectColorSecondary}>
                STORE HOURS:
              </Heading>
              <Text>
                <Icon as={BsCalendar2Check} color={projectColorTertiary} /> We
                are open from Monday to Friday, 9:00 AM to 5:00 PM.
              </Text>
            </VStack>
            <VStack alignItems={"start"}>
              <Heading size="md" color={projectColorSecondary}>
              ...
              <Text>
                <Icon as={BsEnvelope} color={projectColorTertiary} />{" "}
                studiomix1@gmail.com
              </Text>
            </VStack>
          </SimpleGrid>
        </VStack>
